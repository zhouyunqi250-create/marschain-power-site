...
- 使用 GitHub Actions 每 24 小时自动抓取一次数据，抓取时间为每日 08:00（北京时间）
...
- [update-marschain-site.yml](.github/workflows/update-marschain-site.yml)：每日 08:00（北京时间）自动更新的 GitHub Actions 工作流
