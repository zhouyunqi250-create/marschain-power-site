...
- 使用 GitHub Actions 每日 08:01 先刷新官方快照，08:05 起继续全量扫描和站点更新
...
- [fast-update-marschain-site.yml](.github/workflows/fast-update-marschain-site.yml)：每日 08:01 的官方快照快更工作流
